...
- **Fire sale (7-day close):** $22,000 USD floor
...
**Replacement cost at $75/hr senior full-stack rate:** ~500 hours × $75 = **$37,650** (line-item breakdown below). Asking **$35K firm — 7% below replacement cost** — priced for a fast close.
...
Asking **$35,000** reflects not just dev-hours but the **wow-factor differentiators** each Tier A feature adds — priced 7% below replacement cost to close fast:
...
Effective per-hour ratio: **$35,000 / 509h = $69/hour of dev time equivalent** — 8% below the $75/hr senior full-stack rate itself. Buyer captures the discount for pre-revenue + taking over.
...
TripLoop can be bundled with **FiestaMap** (GDL events marketplace, Next 16 + Supabase PostGIS + MapLibre freemium) at **$40,000 total** for the "LATAM/AI travel duo" — same underlying tech patterns, complementary verticals. See `BUNDLE.md`.
...
**Serious inquiries only.** Not looking for advice on the price or the market — the numbers above are researched (`reference-monetization-ideas-2026-08-26`, `reference-portfolio-vercel-audit-2026-08-25` in my memory). Not looking for "will you split for $5K" — floor is $22K (7-day fire sale only).

Contact: GitHub Issues or `hola@nano-almacen.mx`.

_Listing valid until 2026-12-31 or first serious offer. Price firm at $35K for the 30-day active listing period; may re-price to $45K if no offers by 60d, or drop to $22K fire-sale window for a 7-day close._
