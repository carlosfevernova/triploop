  ...
  return (
    <main className="mx-auto max-w-4xl px-8 py-10">
      ...
      <header className="mb-10 border-b border-ink-100 pb-6">
        ...
        <p className="mt-2 text-[14px] text-ink-500">Vista de socios · 2026-08-08 · Producto en producción · <b>24 regiones · 7 continentes · Streaming SSE · Itinerary Intelligence live (S45: routing real + opening hours + schedule/optimize day)</b></p>
      </header>
