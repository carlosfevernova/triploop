...
// Métricas reales medidas 2026-08-10 (post S71e — 4-locale expansion + mobile drawer Portal fix + a11y polish)
const LOC = 27387;                // +767 desde S69 (S70 4 locales + Nav Portal + Unsplash + sitemap + a11y)
const FILES_TSX = 166;            // +2: DestinationsMarquee, PremiumFX
const FILES_TS = 85;
const APIS = 51;
const COMPONENTS = 65;            // +2: DestinationsMarquee, PremiumFX
const PAGES = 79;
const MIGRATIONS = 24;
...
const CONTINENTS = 7;
const LOCALES = 4;                // en, es, pt, de (S70)
