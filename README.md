...
[![Prospectus](https://img.shields.io/badge/for%20sale-%2437K%20firm-orange)](./FOR_SALE.md)
...
> **🏷 FOR SALE:** Production-ready AI road-trip planner. Full-stack Next.js 15 + Supabase + Stripe + multi-provider AI + PWA. **Asking $37,000 USD firm ($47,000 with 60-day handoff + 8h consulting).** See [FOR_SALE.md](./FOR_SALE.md) for full details.
