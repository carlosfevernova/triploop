...
### Asking Price
`$55,000 USD` (firm; buy-it-now $65,000 with 60-day handoff + 8h support)
...
### Reserve Price
`$25,000 USD` (allows negotiation window from $55K asking)

### Buy It Now
`$65,000 USD` (premium immediate close with 60-day handoff + 8h consulting)
...
Asking $55K firm. Buy-it-now $65K con 8h consulting.
...
Asking $55K firm — comparable to what Layla-adjacent teams pay to skip 6-9 months of dev + content curation.
...
**Title:** `[FOR SALE] TripLoop — AI road-trip planner SaaS, 27.8K LOC, Next 15 + Supabase + Stripe + 4 locales. $55K.`
...
- **Realistic 30-day listing:** $27-37K
- **With screenshots + Loom + admin reports polish:** $32-47K
...
| Buyer says | Response |
|---|---|
| "$55K is high for pre-revenue" | "Replacement cost line-item is $55,000+ at $75/hr senior rate. Asking already discounts for pre-revenue. See FOR_SALE.md valuation table." |
...
| "Why only $55K? Should be $55K+" | "Fair point — I priced for a fast close. Willing to hold at $55K firm for the 30-day active listing period; will re-price to $65K if no offers by then." |
